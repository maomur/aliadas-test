...
class App {
    ...
    botonTest = document.querySelector('#day360')
    ...
    constructor() {
        ...
        this.validacion();
        this.localIni();
        this.botonTest.addEventListener('click', () => { this.day360('2022-01-01', '2022-12-31') })

        //this.botonLiquidaciones.addEventListener('click', () => this.imprimir())
    }
    ...
    day360(sd, fd, m) {
        ...
        dm = d2_m - d1_m;
        dd = d2_d - d1_d;
        console.log(parseFloat(dy * 360 + dm * 30 + dd));
